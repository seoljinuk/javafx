                ...
                switch (menu){
                    case 0: // "어린이"
                        tableData = FXCollections.observableArrayList(
                                new Article(null, "어린이01", "child01.jpg"),
                                new Article(null, "어린이02", "child02.jpg"),
                                new Article(null, "어린이03", "child03.jpg"),
                                new Article(null, "어린이04", "child04.jpg")
                        );
                        break;
                    case 1: // "음료수"
                        tableData = FXCollections.observableArrayList(
                                new Article(null, "아메리카노", "americano01.png"),
                                new Article(null, "카푸치노", "cappuccino01.png"),
                                new Article(null, "바닐라라떼", "vanilla_latte_01.png"),
                                new Article(null, "화이트와인", "whitewine01.png")
                        );
                        break;
                    case 2:// "빵"
                        tableData = FXCollections.observableArrayList(
                                new Article(null, "브리오슈", "brioche_01.png"),
                                new Article(null, "치아바타", "ciabatta_01.png"),
                                new Article(null, "크로아상", "croissant_01.png"),
                                new Article(null, "프렌치바게트", "french_baguette_01.png")
                        );
                        break;
                } // end switch
